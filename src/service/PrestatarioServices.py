...
@app.post("/delete_prestatario_by_id/",tags=["Prestatario"])
...
def find_prestatario_by_nombre_apellido(item_nombre:int,item_apellido:int,session: Session = Depends(get_session)):
